...
//NVM size for migration
//#define NVMCAP 1024*1024*1024*8 //8GB
#define NVMBSIZE 4096 //4KB
#define NVMBLOCK 1024*1024*4
#define EXPECTBLOCK 1024*1024*256
#define SSD_NUM 3
/*
...
struct pmfs_super_block {
	...
	__le64      free_nvm_blockaddr;
	__le64 		free_ssd1_blockaddr;
	__le64 		free_ssd2_blockaddr;
	__le64 		free_ssd3_blockaddr;
