...
/*
	...
	pmfs_dbg_verbose("%s: dax_supported = %d; bdev->super=0x%p",
				      ...
				      unsigned long size)
{
	...
	super->free_nvm_blockaddr = cpu_to_le64(0);   //設置初始值
	super->free_ssd1_blockaddr = cpu_to_le64(1);
	super->free_ssd2_blockaddr = cpu_to_le64(1);
	super->free_ssd3_blockaddr = cpu_to_le64(1);
	super->u_free_inode_base = cpu_to_le64(0);
